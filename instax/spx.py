...
class SPx:
    ...
    def __init__(self, ip, port, timeout, pinCode):
    ...
    def connect(self):
        ...
        logging.debug(f"Connecting to Instax {self.name} with timeout of: {self.timeout}")
    ...
    def getPrinterInformation(self):
        """Primary function to get printer information."""
        self.connect()
    ...
    def printPhoto(self, imageBytes, progress):
        ...
        self.sendPrepImageCommand(16, 0, self.image_size)
...
class SP2(SPx):
    def __init__(self, ip="192.168.0.251", port=8080, timeout=10, pinCode=1111) -> None:
        SPx.__init__(ip, port, timeout, pinCode)
        self.name = "SP-2"
        self.image_size = 1440000
        self.segments = 24
